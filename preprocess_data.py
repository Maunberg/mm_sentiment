...
input_file = '/home/dutov@ad.speechpro.com/work/course/Data_Train_modified.csv'
window = 2
overlap = 0.5
...
if not os.path.exists('ex'):
    os.mkdir('ex')
name = f'ex/features_w{window}_o{overlap}.pickle'
with open(name, 'wb') as f:
    pickle.dump(features, f)

name = f'ex/targets_w{window}_o{overlap}.pickle'
with open(name, 'wb') as f:
