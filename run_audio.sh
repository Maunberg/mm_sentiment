...
python train_parse.py --features_type 'voice' --version 'RES' --window 1 --overlap 0 --mode 'spectr'
python train_parse.py --features_type 'voice' --version 'RES' --window 1 --overlap 0.5 --mode 'spectr'
python train_parse.py --features_type 'voice' --version 'RES' --window 2 --overlap 0 --mode 'spectr'
python train_parse.py --features_type 'voice' --version 'RES' --window 2 --overlap 0.5 --mode 'spectr'
python train_parse.py --features_type 'voice' --version 'RES' --window 3 --overlap 0 --mode 'spectr'
python train_parse.py --features_type 'voice' --version 'RES' --window 4 --overlap 0 --mode 'spectr'

echo '\n\n\n\n\nMEL T\n\n\n\n'

python train_parse.py --features_type 'voice' --version 'RES' --window 1 --overlap 0 --mode 'mel'
python train_parse.py --features_type 'voice' --version 'RES' --window 1 --overlap 0.5 --mode 'mel'
python train_parse.py --features_type 'voice' --version 'RES' --window 2 --overlap 0 --mode 'mel'
python train_parse.py --features_type 'voice' --version 'RES' --window 2 --overlap 0.5 --mode 'mel'
python train_parse.py --features_type 'voice' --version 'RES' --window 3 --overlap 0 --mode 'mel'
python train_parse.py --features_type 'voice' --version 'RES' --window 4 --overlap 0 --mode 'mel'

echo '\n\n\n\n\nMFCC T\n\n\n\n'

python train_parse.py --features_type 'voice' --version 'RES' --window 1 --overlap 0 --mode 'mfcc'
python train_parse.py --features_type 'voice' --version 'RES' --window 1 --overlap 0.5 --mode 'mfcc'
python train_parse.py --features_type 'voice' --version 'RES' --window 2 --overlap 0 --mode 'mfcc'
python train_parse.py --features_type 'voice' --version 'RES' --window 2 --overlap 0.5 --mode 'mfcc'
python train_parse.py --features_type 'voice' --version 'RES' --window 3 --overlap 0 --mode 'mfcc'
python train_parse.py --features_type 'voice' --version 'RES' --window 4 --overlap 0 --mode 'mfcc'
