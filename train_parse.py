...
from utils import classifier_v1, classifier_v1_token, classifier_v1_bert
from utils import classifier_v2, classifier_v2_token, classifier_v2_bert
...
parser.add_argument('--features_type', type=str, 
    choices=['text', 'voice'],   #MAIN
    default='voice', help='Type of features')
parser.add_argument('--version', type=str, 
    choices=['FNN', 'T'], default='T',  #MAIN
    help='Model version')
...
parser.add_argument('--mode', type=str, default='mel', 
    choices=['mel', 'mfcc', 'spectr', 'tfidf', 'token', 'bert'], 
